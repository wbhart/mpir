    ...
    public class ExpressionTests
    {
        ...
        public void TestAllExpressions()
        {
            ...
            using (var b = new HugeInt("43827349058270349857203948752093847502934875203"))
            {
                ...
                expr = expr + (-4253049870987L - 2 * a) + (9872340944UL - 4 * b);
                VerifyPartialResult(expr, "-44527683379886113418724460764726984856717156388775636972448492072920883239528380583662970502609288272739831325295051352018030110273519077513070609558584766157041440002331614418072245492715391037393276478007321479952908593757269699484");
