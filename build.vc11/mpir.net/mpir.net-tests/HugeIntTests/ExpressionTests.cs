    ...
    public class ExpressionTests
    {
        ...
        public void TestAllExpressions()
        {
            ...
            using (var b = new HugeInt("43827349058270349857203948752093847502934875203"))
            {
                ...
                expr = expr - (a * 5).DivideExactly(a) - (b * 7 * 5432198).DivideExactly(5432198);
                VerifyPartialResult(expr, "4180446902195206719617566310326378596565810835566654267781162776719604215299073884627215328230474593334065119233043655173219316755562839854530772656851688018991823916079914637003510586121");
