...
#define mpmpn_revbin __MPN(revbin)
__GMP_DECLSPEC mp_limb_t mpmpn_revbin __GMP_PROTO ((mp_limb_t in, mp_limb_t bits));
...
__GMP_EXTERN_INLINE
mp_limb_t n_randint(gmp_randstate_t state, mp_limb_t limit) 
{   mp_limb_t t;
